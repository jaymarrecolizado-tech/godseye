...
// DASHBOARD SUMMARY
// ============================================
router.get('/summary', reportValidation.dateRange, async (req, res, next) => {
  try {
...
// ============================================
router.get('/by-status', reportValidation.dateRange, async (req, res, next) => {
  try {
...
// ============================================
router.get('/by-location', reportValidation.dateRange, async (req, res, next) => {
  try {
...
// TIMELINE REPORT
// ============================================
router.get('/timeline', reportValidation.dateRange, async (req, res, next) => {
  try {
...
// ============================================
router.get('/by-project-type', reportValidation.dateRange, async (req, res, next) => {
  try {
    const { date_from, date_to } = req.query;
